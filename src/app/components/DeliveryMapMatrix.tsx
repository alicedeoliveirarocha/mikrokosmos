// src/app/components/DeliveryMapMatrix.tsx
// ═══════════════════════════════════════════════════════════════
// Modo MATRIX 💊 — a visualização cyberpunk original do tracking.
// É a versão estilizada (SVG neon + MapEffects) preservada como um
// modo alternativo de exibição. O DeliveryMap alterna entre este
// componente e o mapa real (Leaflet + OpenStreetMap).
// Mesmas props, mesmo i18n (namespace deliveryMap).
// ═══════════════════════════════════════════════════════════════
...
interface DeliveryMapMatrixProps {
  orderId: string;
  customerName: string;
