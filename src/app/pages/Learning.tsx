  ...
  const concepts = [
    {
      ...
      topics: [
        ...
        'Manipulação de DOM - Dinamismo no cardápio',
      ],
    ...
    },
    {
      ...
      topics: [
        ...
        'Eventos e Interatividade - Carrinho',
        'Introdução ao Firebase e Supabase',
        'Sprint 2: CRUD Cardápio',
      ],
    ...
    },
    {
      ...
      topics: [
        'Real-time Database: CRUD de Pedidos',
        'Fetch API e Async/Await',
        'UX/UI Design: Status e Feedback',
    ...
    },
    {
      ...
      topics: [
        ...
        'Integração de Módulos com Frameworks',
      ...
      <main className="max-w-6xl mx-auto px-4 py-8 pb-20">
        ...
        >
          ...
          <p className="text-xl text-white/70 mb-2">
            Conceitos do Cronograma Aplicados no Projeto
          </p>
          <p className="text-white/50">
            Período: 03/03/26 - 24/06/26 • Desenvolvimento Front-End
          </p>
        </motion.div>

        {/* Timeline de Conceitos */}
        ...
        >
          <h3 className="text-xl font-bold text-white mb-4">Features do Projeto</h3>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {[
              '4 Universos Temáticos',
              'Carrinho de Compras',
              '12 Produtos Únicos',
              'Animações Suaves',
              'Design Responsivo',
