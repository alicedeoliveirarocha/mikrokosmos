...
export const photocards: Photocard[] = [
  ...
  { id: 'bts-rm-rare',      member: 'RM',       groupName: 'BTS', group: 'bts', rarity: 'rare',       era: 'Hooligans',           imageUrl: '/photocards/BTS/rm-rare.jpg' },
  { id: 'bts-suga-rare',    member: 'Suga',     groupName: 'BTS', group: 'bts', rarity: 'rare',       era: 'Agust D',             imageUrl: '/photocards/BTS/suga-rare.jpg' },
  { id: 'bts-jhope-rare',   member: 'J-Hope',   groupName: 'BTS', group: 'bts', rarity: 'rare',       era: 'Arirang',             imageUrl: '/photocards/BTS/jhope-rare.jpg' },
  { id: 'bts-ultra-rare',   member: 'BTS',      groupName: 'BTS', group: 'bts', rarity: 'ultra-rare', era: 'Arirang',             imageUrl: '/photocards/BTS/bts-ultra-rare.jpg', isGroupPhoto: true },

  // ── BLACKPINK ──────────────────────────────────────────────────
  { id: 'bp-jisoo-common',  member: 'Jisoo',    groupName: 'BLACKPINK', group: 'blackpink', rarity: 'common',     era: 'Airport',       imageUrl: '/photocards/BLACKPINK/jisoo-common.jpg' },
  { id: 'bp-jennie-common', member: 'Jennie',   groupName: 'BLACKPINK', group: 'blackpink', rarity: 'common',     era: 'Paris',         imageUrl: '/photocards/BLACKPINK/jennie-common.jpg' },
  ...
  { id: 'en-sunghoon-rare',   member: 'Sunghoon', groupName: 'ENHYPEN', group: 'enhypen', rarity: 'rare',       era: 'Romance Untold',   imageUrl: '/photocards/ENHYPEN/jake-rare2.jpg' },
  ...
  // ── NEWJEANS ───────────────────────────────────────────────────
  { id: 'nj-hanni-common',    member: 'Hanni',    groupName: 'NewJeans', group: 'newjeans', rarity: 'common',     era: 'Ditto',       imageUrl: '/photocards/NEWJEANS/hanni-common.jpg' },
  { id: 'nj-hyein-common',    member: 'Hyein',    groupName: 'NewJeans', group: 'newjeans', rarity: 'common',     era: 'Daily',       imageUrl: '/photocards/NEWJEANS/hyein-common.jpg' },
  ...
  { id: 'nj-haerin-rare',     member: 'Haerin',   groupName: 'NewJeans', group: 'newjeans', rarity: 'rare',       era: 'New Jeans',   imageUrl: '/photocards/NEWJEANS/haerin-rare.jpg' },
  { id: 'nj-hanni-rare',      member: 'Hanni',    groupName: 'NewJeans', group: 'newjeans', rarity: 'rare',       era: 'Airport',     imageUrl: '/photocards/NEWJEANS/hanni-rare.jpg' },
  { id: 'nj-minji-rare',      member: 'Minji',    groupName: 'NewJeans', group: 'newjeans', rarity: 'rare',       era: 'Selca',       imageUrl: '/photocards/NEWJEANS/minji-rare.jpg' },
  { id: 'minji-ultra-rare',   member: 'Minji',    groupName: 'NewJeans', group: 'newjeans', rarity: 'ultra-rare', era: 'Super Shy',   imageUrl: '/photocards/NEWJEANS/minji-ultra-rare.jpg'},
  { id: 'nj-ultra-rare2',     member: 'NewJeans', groupName: 'NewJeans', group: 'newjeans', rarity: 'ultra-rare', era: 'Hogwarts',    imageUrl: '/photocards/NEWJEANS/nj-ultra-rare2.jpg', isGroupPhoto: true },
  ...
  { id: 'il-minju-rare',    member: 'Minju',  groupName: 'ILLIT', group: 'illit', rarity: 'rare',       era: "Tick-Tack",        imageUrl: '/photocards/ILLIT/minju-rare.jpg' },
  { id: 'il-yunah-rare',    member: 'Yunah',  groupName: 'ILLIT', group: 'illit', rarity: 'rare',       era: 'Its Me',           imageUrl: '/photocards/ILLIT/yunah-rare.jpg' },
